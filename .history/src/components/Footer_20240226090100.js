        ...
        <div>
          <div className='grid grid-cols-3'>
            <div className='flex gap-4 items-center '>
              {
                ImgList.map((data) => (
                  <div className='border rounded-sm border-gray-300 w-[89.25px] h-[48px] justify-center items-center'>
                    <img src={data.img} alt=""></img>
                  </div>
                ))
              }
            </div>
            <div className='text-primary flex gap-6 text-xl items-center justify-center' >
              <FaFacebookF />
              <FaFacebookF />
              <FaFacebookF />
              <FaFacebookF />
