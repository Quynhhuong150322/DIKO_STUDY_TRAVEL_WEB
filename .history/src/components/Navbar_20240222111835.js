        ...
        <div className='bg-neutral '>
            <div className="">
                ...
                <div className='flex gap-2 items-center'>
                    ...
                    <div className=''>
                        <button className='bg-gradient-to-r from-primary to-secondary hover:scale-105 duration-200 text-white py-2 px-4 rounded-sm'>
                            Sing In
                        </button>
                        <button className='bg-neutral border-1 hover:scale-105 duration-200 text-white py-2 px-4 rounded-sm'>
                            Register
                        </button>
                    </div>
                    <div>
