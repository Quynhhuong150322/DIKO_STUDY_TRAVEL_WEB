        ...
        <div className='bg-neutral '>
            <div className="">
                ...
                <div className='flex gap-2 items-center'>
                    ...
                    <div className='flex gap-2 items-center'>
                        <button className='w-[189px]border-solid border-2 border-primary bg-neutral text-black hover:scale-105 duration-200 text-white py-2 px-4 rounded-sm'>
                            Sing In
                        </button>
                        <button className='border-solid border-2 border-primary bg-neutral text-black hover:scale-105 duration-200 text-white py-2 px-4 rounded-sm'>
                            Register
                        </button>
                    </div>
                    <div>
