...
const Langding = () => {
  return (
    <div>
      <div className='relative' style={BannerImg}>
        <div className='max-container absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 backdrop-blur-sm p-8 bg-opacity-0'>
