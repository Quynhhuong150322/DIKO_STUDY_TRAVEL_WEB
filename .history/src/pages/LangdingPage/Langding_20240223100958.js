            ...
            <div className=''>
              {
                ListMenu.map((data) => (
                  <><input
                    type="checkbox"
                    className="w-[24px] h-[24px] border border-gray-300 px-2 py-1 focus:outline-none focus:border-1 focus:border-primary" /><label for="checkbox" className=''>{data.name}</label></>
                ))
              }
