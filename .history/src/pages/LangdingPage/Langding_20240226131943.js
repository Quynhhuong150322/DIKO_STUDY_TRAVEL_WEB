...
const FooterImg = {
  backgroundImage: `linear-gradient(to top, rgba(0, 0, 0, 0.8), rgba(169,169,169, 0.7)), url(${Footer})`,
  backgroundPosition: "center",
  backgroundRepeat: "no-repeat",
  backgroundSize: "cover",
  height: "394px",
...
const Langding = () => {
  return (
    <div >
      ...
      {/* Banner Footer  */}
      <div className='background  mix-blend-overlay' style={FooterImg}>
        <div className='flex flex-col gap-28 py-10'>
          <div className='font-bold text-white px-20'>
          ...
          <div className='text-white px-20 text-right '>
            <h1 className='font-bold text-3xl basis-1/4'>Difficult Roads Lead To Beautiful Destination .</h1>
