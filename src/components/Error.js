    ...
    return (
        <div className="w-full h-[750px] relative">
            ...
            <div className="absolute top-[25%] left-1/2 transform translate-x-[-50%] z-50 bg-transparent flex flex-col gap-10 justify-center items-center">
                <h1 className="bg-transparent text-8xl font-bold text-[#D9D9D9]">404</h1>
                <h3 className="bg-transparent text-[24px] font-bold text-[#FFFFFF]">The page Was not Found ,Sorry!</h3>
                <Link to="/">
